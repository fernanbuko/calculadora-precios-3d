...
Para piezas planas y delgadas (llaveros, placas, insignias...) hay un interruptor **🔑 Pieza plana** que reemplaza el campo de tamaño por sus medidas reales — ancho × alto × grosor, en milímetros —, útiles para llevar el registro de la pieza. Con algo tan delgado, el estimado genérico por tamaño no sirve (no escala como un cubo) y tampoco hay forma confiable de adivinar el peso solo con las medidas sin saber la densidad del filamento — así que en este modo el peso pasa a ser obligatorio: pésala o mira tu slicer y ponlo directamente.
