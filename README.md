...
**Inicio** es justo eso: lo primero que ves al abrir la app. Saluda según la hora — usa siempre la hora de Ecuador (America/Guayaquil), sin importar en qué zona horaria esté el dispositivo — y muestra cuántos artículos tienes por hacer, por entregar y por cobrar (sin montos de dinero, solo cantidades), más la sección de "Pendientes" agrupada por cliente, para tener un vistazo del negocio sin tener que entrar a la pestaña de Pedidos — tocar un cliente ahí te lleva directo a su perfil, en Pedidos.
