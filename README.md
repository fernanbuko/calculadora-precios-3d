...
- **Cuenta bancaria y compartir por WhatsApp**: en Finanzas, debajo del resumen de lo generado/por cobrar, hay un cuadro de texto libre para poner los datos de tu cuenta (banco, número, alias, titular... lo que necesites) — se guarda solo, sin botón aparte, y sincroniza a la nube igual que el resto si iniciaste sesión. El botón "📱 Compartir por WhatsApp" abre WhatsApp con ese texto tal cual lo escribiste (sin agregarle nada) listo para mandarle a quien corresponda.
