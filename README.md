...
- **Pedidos**: registra qué le debes entregar a cada cliente y cuánto cobrar (con el botón "Usar precio calculado" para copiar el precio de la calculadora), marca cada uno como pagado/entregado con un toque, edítalos cuando cambien los datos, y ve de un vistazo cuánto tienes por cobrar y cuántos pedidos faltan por entregar.
